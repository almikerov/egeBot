...
if not all([TELEGRAM_TOKEN, GEMINI_API_KEY, ROBOKASSA_MERCHANT_LOGIN, ROBOKASSA_PASSWORD_1, ROBOKASSA_PASSWORD_2]):
...
# Придумайте секретную команду-пароль для входа в админку
